  ...
  <body style="background:url(&#39;../images/balloons_back_bg.jpg&#39;) repeat">
    ...
    <div class="container">
	  ...
	  <div class=" hidden-xs col-sm-2">
		<img width="200" src="../images/logo.png" class="img-responsive" alt="Responsive image"/>
		</div>
        <div class="col-sm-10">
            <h1>Balloon Shop 
            <small>selling happiness</small></h1>
      ...
      <div class="row">
        <div class="col-lg-2 col-md-3">
          ...
          <a class="list-group-item" href="#">Wedding</a> 
          <a class="list-group-item" href="#">Cartoons</a> 
          <a class="list-group-item" href="#">Message balloons</a>
		  </div>
		  </div>
            ...
            <div class="col-lg-4 col-sm-6 col-xs-12">
              <div class="panel panel-default">
                <div class="panel-body">
                  ...
                  <img src="../images/balonce.jpg" class="img img-thumbnail img-responsive" />
